    ...
    <div class="main">
      <div class="container-fluid">
        <div class="col-md-12">
          ...
          ?>
          <h1 class="fw-bold text-uppercase">Add Loan</h1>
        </div>
        <!-- tabs row start  -->
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">Fill The Details of the Loan</div>
              <div class="card-body">
                <form action="../models/loan/add_loan.php" method="POST">
                  <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <button type="submit" name="add_loan" class="btn btn-success">Save</button>
